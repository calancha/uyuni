...
@long_test
@scc_credentials
  Scenario: Enable "SUSE Linux Enterprise Server 15 SP3 with Basesystem module for x86_64"
    Given I am on the Products page
    When I enter "SUSE Linux Enterprise Server 15 SP3" as the filtered product description
    And I select "x86_64" in the dropdown list of the architecture filter
    And I open the sub-list of the product "SUSE Linux Enterprise Server 15 SP3 x86_64 (ALPHA)"
    ...
    Then I should see that the "Server Applications Module 15 SP3 x86_64" product is "recommended"
    When I select "SUSE Linux Enterprise Server 15 SP3 x86_64 (ALPHA)" as a product
    And I deselect "SUSE Manager Tools 15 x86_64 (BETA)" as a SUSE Manager product
    And I deselect "Server Applications Module 15 SP3 x86_64" as a product
    And I click the Add Product button
    And I wait until I see "SUSE Linux Enterprise Server 15 SP3 x86_64" product has been added
    Then the SLE15SP3 base products should be added
